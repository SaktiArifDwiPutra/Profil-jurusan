...
if ($id <= 0) { header('Location: /ProfilJurusan/index.php'); exit; }
  ...
  <div class="col-md-8">
    <article class="card p-4 mb-4 shadow-sm">
      ...
      <div class="d-flex justify-content-between">
        <a href="/ProfilJurusan/index.php" class="btn btn-danger">← Kembali</a>
      </div>
    </article>
    ...
    <section id="comments" class="card p-4 shadow-sm">
      ...
      <?php else: ?>
        <div class="mt-3 small text-muted">
          Silakan <a href="/ProfilJurusan/auth/login.php" class="link-secondary">login</a> untuk mengomentari.
        </div>
      <?php endif; ?>
    </section>
  </div>
