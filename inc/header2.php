    ...
    <div class="collapse navbar-collapse" id="navMain">
      <ul class="navbar-nav ms-auto">
        ...
        <?php elseif($role === 'guru'): ?>
          <li class="nav-item"><a class="nav-link" href="/ProfilJurusan/guru/dashboard.php"><i class="fa fa-home"></i> Dashboard</a></li>
          <li class="nav-item"><a class="nav-link" href="/ProfilJurusan/guru/nilai.php">Kelola Nilai</a></li>
          <li class="nav-item"><a class="nav-link" href="/ProfilJurusan/guru/siswa.php">Siswa</a></li>
          <li class="nav-item"><a class="nav-link text-danger" href="/ProfilJurusan/auth/logout.php">Logout</a></li>

        <?php elseif($role === 'siswa'): ?>
          <li class="nav-item"><a class="nav-link" href="/ProfilJurusan/siswa/dashboard.php"><i class="fa fa-home"></i> Dashboard</a></li>
          <li class="nav-item"><a class="nav-link" href="/ProfilJurusan/siswa/nilai.php">Nilai Saya</a></li>
          <li class="nav-item"><a class="nav-link" href="/ProfilJurusan/siswa/guru.php">Guru</a></li>
          <li class="nav-item"><a class="nav-link text-danger" href="/ProfilJurusan/auth/logout.php">Logout brr</a></li>
