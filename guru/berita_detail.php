...
if ($id <= 0) { header('Location: /ProfilJurusan/guru/berita.php'); exit; }
...
if (isset($_GET['hapus_komen'])) {
    ...
    header('Location: /ProfilJurusan/guru/berita_detail.php?id='.$id.'#comments'); exit;
}
  ...
  <div class="col-md-8">
    <article class="card p-4 mb-4 shadow-sm">
      ...
      <div class="d-flex justify-content-between">
        <a href="/ProfilJurusan/guru/dashboard.php" class="btn btn-danger">← Kembali</a>
      </div>
    </article>
              ...
              <div class="ms-auto">
                <?php
                  ...
                  if(is_logged_in() && ($userId==$c['id_user'] || ($u['role']??'')==='admin')): ?>
                    <a href="/ProfilJurusan/guru/berita_detail.php?id=<?=$id?>&hapus_komen=<?=$c['id_komentar']?>" 
  ...
  <div class="col-md-4">
    <div class="card p-4 shadow-sm mb-4">
      ...
      <ul class="list-unstyled mb-0">
        ...
        foreach($others as $o): ?>
          <li class="mb-2">
            <a href="/ProfilJurusan/guru/berita_detail.php?id=<?=$o['id_berita']?>" class="link-primary fw-medium">
